...
사용자가 실제로 답변한 내용만 바탕으로 위 7가지 지표를 종합하여 분석하세요. 각 지표에 대해 구체적이고 명확하게 분석하되, 사용자가 언급하지 않은 것은 추측하지 마세요.

다음 JSON 형식으로 응답해주세요:
{
  "meaningMaking": "인지적 해석 분석 (한국어, 150-200자)",
  "empathicResonance": "감정 공감 분석 (한국어, 150-200자)",
  "imaginativeCompletion": "상상적 보완 분석 (한국어, 150-200자)",
  "valueOrientation": "가치 판단 분석 (한국어, 150-200자)",
  "situationalReasoning": "상황 판단 분석 (한국어, 150-200자)",
  "interpersonalLens": "대인 감수성 분석 (한국어, 150-200자)",
  "selfProjection": "자기 투사 분석 (한국어, 150-200자)"
}`;
      ...
      try {
        ...
        try {
          ...
          const analysisData = {
            meaningMaking: "사용자의 답변을 통해 관찰 우선순위와 의미부여 경향을 분석한 결과입니다.",
            empathicResonance: "사용자가 보여준 감정 인식 민감도와 공감 방식을 분석한 결과입니다.",
            imaginativeCompletion: "사용자의 상상 경향과 사고의 확산성을 분석한 결과입니다.",
            valueOrientation: "사용자의 답변에서 드러난 가치 기준과 판단 스타일을 분석한 결과입니다.",
            situationalReasoning: "사용자의 논리 판단과 문제 해결 방향을 분석한 결과입니다.",
            interpersonalLens: "사용자의 관계 지향성과 대인 감각을 분석한 결과입니다.",
            selfProjection: "사용자의 자기 동일시 방식과 경험 기반 해석 패턴을 분석한 결과입니다."
          };
