  ...
  const blocks = [
    {
      ...
      boxes: [
        ...
        { style: 'top-[12%] left-[5%]', tooltip: '따뜻한 빛이 비추는 벽면 위, 낡은 보안카메라가 고요히 시선을 고정하고 있습니다.\n\n평범한 풍경 속 이 카메라는 존재만으로도 \'감시의 시선\'을 일상의 일부로 만들어냅니다.', image: '/gallery/gallery-1-c.png', maxW: 181, maxH: 240, objectFit: 'contain', tooltipWidth: 280 },
        ...
        { style: 'bottom-[12%] right-[10%]', tooltip: '도심의 높은 시점에서 내려다본 거리에는 사람들과 자전거가 여유롭게 흩어져 있습니다.\n\n질서정연한 도로와 건물 사이로 드리운 그림자는, 인간의 움직임마저 하나의 패턴처럼 기록되는 도시의 리듬을 보여줍니다.', image: '/gallery/gallery-1-a.png', maxW: 160, maxH: 240, objectFit: 'contain', tooltipWidth: 280 },
