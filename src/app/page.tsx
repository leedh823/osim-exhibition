  ...
  const blocks = [
    {
      ...
      boxes: [
        ...
        { style: 'top-[12%] left-[5%]', tooltip: '따뜻한 빛이 비추는 벽면 위, 낡은 보안카메라가 고요히 시선을 고정하고 있습니다.', image: '/gallery/gallery-1-c.png', maxW: 181, maxH: 240, objectFit: 'contain', tooltipWidth: 280 },
