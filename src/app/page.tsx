  ...
  if (currentStep === 'tracking_video') {
    return (
      <div className="w-full h-screen bg-black aspect-[9/16] mx-auto relative overflow-hidden">
        ...
        {/* 자전거 타는 사람 클릭 영역 */}
        <div 
          className="absolute bottom-1/3 left-1/2 transform -translate-x-1/2 w-16 h-24 border-2 border-red-500 animate-pulse-box z-30 cursor-pointer hover:bg-red-500/20 transition-colors"
